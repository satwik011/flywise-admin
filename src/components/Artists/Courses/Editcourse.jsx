...
function Editcourse() {
  ...
  const getdata = async () => {
    setLoading(true);
    try {
      const call1 = await axios.get(
        `https://api.flywise.in/api/courseById/${param.id2}`
      );
  ...
  const handlesubmit = async () => {
    ...
    try {
      await axios.patch(
        `https://api.flywise.in/api/updateCourse/${param.id2}`,
        courseData
      );
        ...
        {loading ? (
          ...
          <div className="addArtist-personalDetails">
            ...
            <div className="addArtist-alignRow">
              ...
              <div className="addArtist-inputFieldDiv">
                <label className="addArtist-inputLabel">Discipline</label>
                <select
            ...
            <div className="addArtist-alignRow">
              <div className="addArtist-inputFieldDiv">
                <label className="addArtist-inputLabel">Toefl Accepted ?</label>
                <RadioGroup
                  aria-labelledby="demo-row-controlled-radio-buttons-group"
                  row
            ...
            <div className="addArtist-alignRow">
              <div className="addArtist-inputFieldDiv">
                <label className="addArtist-inputLabel">IELTS Accepted ?</label>
                <RadioGroup
                  aria-labelledby="demo-row-controlled-radio-buttons-group"
                  row
            ...
            <div className="addArtist-alignRow">
              <div className="addArtist-inputFieldDiv">
                <label className="addArtist-inputLabel">PTE Accepted ?</label>
                <RadioGroup
                  aria-labelledby="demo-row-controlled-radio-buttons-group"
                  row
                  onChange={handlepte}
